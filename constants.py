...
class Config(object):
    ...
    API_ID= 4974865 # integer value, dont use ""
    API_HASH= "156c9e88af180d63ce2b6d117d1f2087"
    TOKEN = "1767399754:AAG4IGwzqQm0_i9zV3HVTatqVGUiqlSfYlo"  # This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    OWNER_ID = 1131653685   # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "@harshithalakruwan"
